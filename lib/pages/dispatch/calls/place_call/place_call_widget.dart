...
import '/backend/schema/company_record.dart';
...
import 'place_call_model.dart';
export 'place_call_model.dart';

/// Create a component to place a call.
///
/// It will take a name and number from user and a button to place call
class PlaceCallWidget extends StatefulWidget {
  const PlaceCallWidget({super.key});

  @override
  State<PlaceCallWidget> createState() => _PlaceCallWidgetState();
}

class _PlaceCallWidgetState extends State<PlaceCallWidget> {
  late PlaceCallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaceCallModel());
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  'Enter contact details to make a call',
            ...
            FFButtonWidget(
              onPressed: () async {
                ...
                final currentUserDocument = await getCurrentUserDocument();
                ...
                final company = await CompanyRecord.getDocumentOnce(currentUserDocument!.company!);
                final companyPhoneNumber = company?.phoneNumberMap?.firstOrNull?.phoneNumber ?? '';
