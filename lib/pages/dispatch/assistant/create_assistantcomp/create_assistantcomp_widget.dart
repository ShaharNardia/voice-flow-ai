...
import 'create_assistantcomp_model.dart';
export 'create_assistantcomp_model.dart';

class CreateAssistantcompWidget extends StatefulWidget {
  const CreateAssistantcompWidget({super.key});

  @override
  State<CreateAssistantcompWidget> createState() =>
      _CreateAssistantcompWidgetState();
}

class _CreateAssistantcompWidgetState extends State<CreateAssistantcompWidget> {
  late CreateAssistantcompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAssistantcompModel());
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          errorBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).customColor26,
                              width: 2.0,
                            ),
                            borderRadius: BorderRadius.circular(8.0),
                          ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options:
                          List<String>.from(functions.returnLanguageCode()!),
                      optionLabels: functions.returnLanguageName(),
                      onChanged: (val) =>
                      ...
                      hintText: 'Please select language...',
                      searchHintText: 'Search for a language...',
                      icon: Icon(
                      ...
                      onPressed: () async {
                        ...
                        if (currentUserDocument?.company != null) {
                          ...
                          if (_model.comapnay?.reference != null) {
                            _model.apiResultlh7 =
                                await VapiGroup.createAssitantCall.call(
                            ...
                            if ((_model.apiResultlh7?.statusCode ?? 200) ==
                                201) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
