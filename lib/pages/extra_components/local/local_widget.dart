      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(40.0, 40.0, 40.0, 26.0),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: FlutterFlowDropDown<String>(
                                controller: _model.techValueController ??=
                                    FormFieldController<String>(null),
                                options: [''],
                                onChanged: (val) =>
                                    safeSetState(() => _model.techValue = val),
                                width: 250.0,
                                height: 40.0,
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        return FlutterFlowDataTable<int>(
                          ...
                          dataRowBuilder: (jobsItem, jobsIndex, selected,
                                  onSelectChanged) =>
                              DataRow(
