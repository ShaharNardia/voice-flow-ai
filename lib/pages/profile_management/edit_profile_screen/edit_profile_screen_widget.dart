                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadData1mc3 = true);
                            ...
                            try {
                              ...
                              ScaffoldMessenger.of(context)
                                  .hideCurrentSnackBar();
                              _model.isDataUploading_uploadData1mc3 = false;
                            }
                            if (selectedUploadedFiles.length ==
                                selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadData1mc3 =
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      fillColor: FlutterFlowTheme.of(context).secondary,
                      contentPadding:
                          EdgeInsetsDirectional.fromSTEB(20.0, 15.0, 0.0, 15.0),
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.inter(
                            fontWeight: FlutterFlowTheme.of(context)
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model.uploadedFile != null &&
                        ...
                        {
                          safeSetState(() =>
                              _model.isDataUploading_uploadData8i9 = true);
                          var selectedUploadedFiles = <FFUploadedFile>[];
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadData8i9 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedFiles.length &&
                              downloadUrls.length == selectedFiles.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadData8i9 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadData8i9 =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
                        ...
                        await currentUserReference!.update(createUserRecordData(
                          ...
                          photoUrl: _model.uploadedFileUrl_uploadData8i9,
                        ));
                        ...
                        await currentUserReference!.update(createUserRecordData(
                          ...
                          displayName: _model.nameFieldTextController.text,
                          photoUrl: columnUserRecord?.photoUrl,
                        ));
